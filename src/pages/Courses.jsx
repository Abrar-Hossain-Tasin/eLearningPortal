...
const Courses = () => {
  ...
  const categories = ['All', 'Operations', 'Technology', 'Compliance', 'Corporate'];
  const levels = ['All Levels', 'Beginner', 'Intermediate', 'Advanced'];
  ...
  const filteredCourses = courses
    ...
    .sort((a, b) => {
      switch (sortBy) {
        ...
        case 'Newest':
          // Since we don't have dates, we'll use ID as a proxy
          return b.id.localeCompare(a.id);
        case 'Highest Rated':
          return b.rating - a.rating;
        case 'Duration':
          // Extract weeks from duration string and compare
          const getWeeks = (duration) => parseInt(duration);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex items-center space-x-4">
              <span className="text-gray-600 font-medium">Sort by:</span>
              <select 
                className="bg-white border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500"
                value={sortBy}
